...
```{r}
#snpgdsVCF2GDS("data/2017-10-18_gbswgsmerge-oxley/common-variants-all-data.vcf.gz", "data/2017-10-18_gbswgsmerge-oxley/merged-snps.gds")
geno = snpgdsOpen("data/2017-10-18_gbswgsmerge-oxley/merged-snps.gds", allow.duplicate = T)
```
...
```{r}
metadata = read.csv("data/2017-10-18_gbswgsmerge-oxley/merged-euc-metadata.csv")
metadata = metadata %>%
